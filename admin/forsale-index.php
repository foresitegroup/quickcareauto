...
<form action="forsale-db.php?a=add" method="POST" style="float: left;">
  <h3>Add New Car for Sale</h3>
...
<div style="float: right; width: 350px;">
  <h3>Available Cars for Sale</h3>
  
  <?php
  $result = mysql_query("SELECT * FROM forsale ORDER BY id DESC");
  while ($row = mysql_fetch_array($result)) {
  ?>
  <div style="margin-left: 80px;">
    <div class="controls" style="width: 80px; margin-left: -80px;">
      <a href="forsale-db.php?a=delete&id=<?php echo $row['id']; ?>" onClick="return(confirm('Are you sure you want to delete this car?\n\nALL IMAGES ASSOCIATED WITH THIS GALLERY WILL\nBE PERMANENTLY DELETED FROM THE SERVER.'));"><img src="images/delete.png" alt="Delete" title="Delete"></a>
      <a href="forsale-edit.php?id=<?php echo $row['id']; ?>"><img src="images/edit.png" alt="Edit" title="Edit"></a>
      <a href="forsale-db.php?a=publish&id=<?php echo $row['id']; ?>">
      <?php
