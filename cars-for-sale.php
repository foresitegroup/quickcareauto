...
$HeaderImg = "cars-for-sale.jpg";
include "header.php";
?>

<?php
$result = mysql_query("SELECT * FROM forsale WHERE publish != '' ORDER BY id DESC");
...
<div class="car-images">
  <div id="car<?php echo $count; ?>">
    <?php
    $iresult = mysql_query("SELECT * FROM forsaleimages WHERE forsaleid = '" . $row['id'] . "' AND publish != '' ORDER BY sort ASC");
    while($irow = mysql_fetch_array($iresult)) {
      echo "<img src=\"images/forsale/" . $row['id'] . "/" . $irow['image'] . "\" alt=\"\">";
    }
    ?>
